...
public class ItemReg {
    ...
    // Minecarts
    public static final RegistryObject<Item> MINECART_EXPLOSIVE             = ITEMS.register("minecart_explosive",              () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_SHRAPNEL              = ITEMS.register("minecart_shrapnel",               () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_INCENDIARY            = ITEMS.register("minecart_incendiary",             () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_DEBILITATION          = ITEMS.register("minecart_debilitation",           () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_CHEMICAL              = ITEMS.register("minecart_chemical",               () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_ANVIL                 = ITEMS.register("minecart_anvil",                  () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_REPULSIVE             = ITEMS.register("minecart_repulsive",              () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_ATTRACTIVE            = ITEMS.register("minecart_attractive",             () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_NIGHTMARE             = ITEMS.register("minecart_nightmare",              () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_FRAGMENTATION         = ITEMS.register("minecart_fragmentation",          () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_CONTAGIOUS            = ITEMS.register("minecart_contagious",             () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_SONIC                 = ITEMS.register("minecart_sonic",                  () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_BREACHING             = ITEMS.register("minecart_breaching",              () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_REJUVENATION          = ITEMS.register("minecart_rejuvenation",           () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_THERMOBARIC           = ITEMS.register("minecart_thermobaric",            () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_NUCLEAR               = ITEMS.register("minecart_nuclear",                () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_EMP                   = ITEMS.register("minecart_emp",                    () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_EXOTHERMIC            = ITEMS.register("minecart_exothermic",             () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_ENDOTHERMIC           = ITEMS.register("minecart_endothermic",            () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_ANTIGRAVITATIONAL     = ITEMS.register("minecart_antigravitational",      () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_ENDER                 = ITEMS.register("minecart_ender",                  () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_HYPERSONIC            = ITEMS.register("minecart_hypersonic",             () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_ANTIMATTER            = ITEMS.register("minecart_antimatter",             () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final RegistryObject<Item> MINECART_REDMATTER             = ITEMS.register("minecart_redmatter",              () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
