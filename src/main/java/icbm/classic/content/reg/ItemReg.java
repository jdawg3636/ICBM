...
public class ItemReg {
    ...
    public static final RegistryObject<Item> EXPLOSIVES_SHRAPNEL          = ITEMS.register("explosives_shrapnel",          () -> new BlockItem(BlockReg.EXPLOSIVES_SHRAPNEL.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_INCENDIARY        = ITEMS.register("explosives_incendiary",        () -> new BlockItem(BlockReg.EXPLOSIVES_INCENDIARY.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_DEBILITATION      = ITEMS.register("explosives_debilitation",      () -> new BlockItem(BlockReg.EXPLOSIVES_DEBILITATION.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_CHEMICAL          = ITEMS.register("explosives_chemical",          () -> new BlockItem(BlockReg.EXPLOSIVES_CHEMICAL.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_ANVIL             = ITEMS.register("explosives_anvil",             () -> new BlockItem(BlockReg.EXPLOSIVES_ANVIL.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_REPULSIVE         = ITEMS.register("explosives_repulsive",         () -> new BlockItem(BlockReg.EXPLOSIVES_REPULSIVE.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_ATTRACTIVE        = ITEMS.register("explosives_attractive",        () -> new BlockItem(BlockReg.EXPLOSIVES_ATTRACTIVE.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_FRAGMENTATION     = ITEMS.register("explosives_fragmentation",     () -> new BlockItem(BlockReg.EXPLOSIVES_FRAGMENTATION.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_CONTAGIOUS        = ITEMS.register("explosives_contagious",        () -> new BlockItem(BlockReg.EXPLOSIVES_CONTAGIOUS.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_SONIC             = ITEMS.register("explosives_sonic",             () -> new BlockItem(BlockReg.EXPLOSIVES_SONIC.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_BREACHING         = ITEMS.register("explosives_breaching",         () -> new BlockItem(BlockReg.EXPLOSIVES_BREACHING.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_REJUVENATION      = ITEMS.register("explosives_rejuvenation",      () -> new BlockItem(BlockReg.EXPLOSIVES_REJUVENATION.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_THERMOBARIC       = ITEMS.register("explosives_thermobaric",       () -> new BlockItem(BlockReg.EXPLOSIVES_THERMOBARIC.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_NUCLEAR           = ITEMS.register("explosives_nuclear",           () -> new BlockItem(BlockReg.EXPLOSIVES_NUCLEAR.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_EMP               = ITEMS.register("explosives_emp",               () -> new BlockItem(BlockReg.EXPLOSIVES_EMP.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_EXOTHERMIC        = ITEMS.register("explosives_exothermic",        () -> new BlockItem(BlockReg.EXPLOSIVES_EXOTHERMIC.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_ENDOTHERMIC       = ITEMS.register("explosives_endothermic",       () -> new BlockItem(BlockReg.EXPLOSIVES_ENDOTHERMIC.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_ANTIGRAVITATIONAL = ITEMS.register("explosives_antigravitational", () -> new BlockItem(BlockReg.EXPLOSIVES_ANTIGRAVITATIONAL.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_ENDER             = ITEMS.register("explosives_ender",             () -> new BlockItem(BlockReg.EXPLOSIVES_ENDER.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_HYPERSONIC        = ITEMS.register("explosives_hypersonic",        () -> new BlockItem(BlockReg.EXPLOSIVES_HYPERSONIC.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_ANTIMATTER        = ITEMS.register("explosives_antimatter",        () -> new BlockItem(BlockReg.EXPLOSIVES_ANTIMATTER.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_REDMATTER         = ITEMS.register("explosives_redmatter",         () -> new BlockItem(BlockReg.EXPLOSIVES_REDMATTER.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
    public static final RegistryObject<Item> EXPLOSIVES_NIGHTMARE         = ITEMS.register("explosives_nightmare",         () -> new BlockItem(BlockReg.EXPLOSIVES_NIGHTMARE.get(), new Item.Properties().group(ICBMClassic.CREATIVE_TAB)));
