                        ...
                        for (int z = (int) -this.getBlastRadius(); z < (int) this.getBlastRadius(); z++) {
                            ...
                            if (world.isBlockLoaded(blockPos)) {
                                ...
                                if (Math.round(location.x() + y) == location.yi())
                                    world().addParticle(ParticleTypes.LARGE_SMOKE, blockPos.getX() + 0.5, blockPos.getY() + 0.5, blockPos.getZ() + 0.5, 0, 0, 0);
                                    ...
                                    if (ICBMClassicHelpers.hasEmpHandler(iBlockState)) {
                                        ...
                                        if (tileEntity != null) {
                                            ...
                                            if (tileEntity.getCapability(CapabilityEMP.EMP, null).isPresent()) {
                                                ...
                                                IEMPReceiver receiver = tileEntity.getCapability(CapabilityEMP.EMP, null).orElse(null);
                                                ...
                                                else { /* TODO Spawn tick based effect to drain as much energy as possible over several ticks */ }
                ...
                for (Entity entity : entities) {
                    ...
                    if (!MinecraftForge.EVENT_BUS.post(new EmpEvent.EntityPre(this, entity))) {
                        ...
                        if (entity.getCapability(CapabilityEMP.EMP, null).isPresent()) {
                            IEMPReceiver receiver = entity.getCapability(CapabilityEMP.EMP, null).orElse(null);
                            if (receiver != null) {
