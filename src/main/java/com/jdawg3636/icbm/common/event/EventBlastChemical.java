...
public class EventBlastChemical extends AbstractBlastEvent {
    ...
    public EventBlastChemical(BlockPos blastPosition, ServerWorld blastWorld, AbstractBlastEvent.Type blastType) {
        super(blastPosition, blastWorld, blastType, SoundEventReg.EXPLOSION_DEBILITATION);
    }
