...
public class ItemReg {
    ...
    public static final RegistryObject<Item> EXPLOSIVES_CONTAGIOUS          = ITEMS.register("explosives_contagious",           () -> new BlockItem(BlockReg.EXPLOSIVES_CONTAGIOUS.get(), new Item.Properties().tab(ICBMReference.CREATIVE_TAB)));
    ...
    public static final RegistryObject<Item> MINECART_CONTAGIOUS            = ITEMS.register("minecart_contagious",             () -> new MinecartItem(AbstractMinecartEntity.Type.TNT, (new Item.Properties()).stacksTo(1).tab(ICBMReference.CREATIVE_TAB)));
    ...
    public static final RegistryObject<Item> TRACKER                        = ITEMS.register("tracker",                         () -> new Item(new Item.Properties().tab(ICBMReference.CREATIVE_TAB)));
