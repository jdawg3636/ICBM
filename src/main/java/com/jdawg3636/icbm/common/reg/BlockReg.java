...
public class BlockReg {
    ...
    public static final RegistryObject<Block> EXPLOSIVES_CONTAGION          = BLOCKS.register("explosives_contagion",           () -> new BlockExplosives(EntityReg.EXPLOSIVES_CONTAGION,          BlastEvent.Contagion::new,          ItemReg.EXPLOSIVES_CONTAGION));
