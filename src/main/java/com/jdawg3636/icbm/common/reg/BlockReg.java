...
public class BlockReg {
    ...
    public static final RegistryObject<Block> EXPLOSIVES_CHEMICAL           = BLOCKS.register("explosives_chemical",            () -> new BlockExplosives(EntityReg.EXPLOSIVES_CHEMICAL,            EventBlastChemical::new,           ItemReg.EXPLOSIVES_CHEMICAL));
    public static final RegistryObject<Block> EXPLOSIVES_ANVIL              = BLOCKS.register("explosives_anvil",               () -> new BlockExplosives(EntityReg.EXPLOSIVES_ANVIL,               EventBlastAnvil::new,              ItemReg.EXPLOSIVES_ANVIL));
    public static final RegistryObject<Block> EXPLOSIVES_REPULSIVE          = BLOCKS.register("explosives_repulsive",           () -> new BlockExplosives(EntityReg.EXPLOSIVES_REPULSIVE,           EventBlastRepulsive::new,          ItemReg.EXPLOSIVES_REPULSIVE));
    public static final RegistryObject<Block> EXPLOSIVES_ATTRACTIVE         = BLOCKS.register("explosives_attractive",          () -> new BlockExplosives(EntityReg.EXPLOSIVES_ATTRACTIVE,          EventBlastAttractive::new,         ItemReg.EXPLOSIVES_ATTRACTIVE));
    public static final RegistryObject<Block> EXPLOSIVES_NIGHTMARE          = BLOCKS.register("explosives_nightmare",           () -> new BlockExplosives(EntityReg.EXPLOSIVES_NIGHTMARE,           EventBlastNightmare::new,          ItemReg.EXPLOSIVES_NIGHTMARE));
    public static final RegistryObject<Block> EXPLOSIVES_FRAGMENTATION      = BLOCKS.register("explosives_fragmentation",       () -> new BlockExplosives(EntityReg.EXPLOSIVES_FRAGMENTATION,       EventBlastFragmentation::new,      ItemReg.EXPLOSIVES_FRAGMENTATION));
    public static final RegistryObject<Block> EXPLOSIVES_CONTAGION          = BLOCKS.register("explosives_contagion",           () -> new BlockExplosives(EntityReg.EXPLOSIVES_CONTAGION,           EventBlastContagion::new,          ItemReg.EXPLOSIVES_CONTAGION));
    public static final RegistryObject<Block> EXPLOSIVES_SONIC              = BLOCKS.register("explosives_sonic",               () -> new BlockExplosives(EntityReg.EXPLOSIVES_SONIC,               EventBlastSonic::new,              ItemReg.EXPLOSIVES_SONIC));
    public static final RegistryObject<Block> EXPLOSIVES_BREACHING          = BLOCKS.register("explosives_breaching",           () -> new BlockExplosives(EntityReg.EXPLOSIVES_BREACHING,           EventBlastBreaching::new,          ItemReg.EXPLOSIVES_BREACHING));
    public static final RegistryObject<Block> EXPLOSIVES_REJUVENATION       = BLOCKS.register("explosives_rejuvenation",        () -> new BlockExplosives(EntityReg.EXPLOSIVES_REJUVENATION,        EventBlastRejuvenation::new,       ItemReg.EXPLOSIVES_REJUVENATION));
    public static final RegistryObject<Block> EXPLOSIVES_THERMOBARIC        = BLOCKS.register("explosives_thermobaric",         () -> new BlockExplosives(EntityReg.EXPLOSIVES_THERMOBARIC,         EventBlastThermobaric::new,        ItemReg.EXPLOSIVES_THERMOBARIC));
    public static final RegistryObject<Block> EXPLOSIVES_NUCLEAR            = BLOCKS.register("explosives_nuclear",             () -> new BlockExplosives(EntityReg.EXPLOSIVES_NUCLEAR,             EventBlastNuclear::new,            ItemReg.EXPLOSIVES_NUCLEAR));
    public static final RegistryObject<Block> EXPLOSIVES_EMP                = BLOCKS.register("explosives_emp",                 () -> new BlockExplosives(EntityReg.EXPLOSIVES_EMP,                 EventBlastEmp::new,                ItemReg.EXPLOSIVES_EMP));
    public static final RegistryObject<Block> EXPLOSIVES_EXOTHERMIC         = BLOCKS.register("explosives_exothermic",          () -> new BlockExplosives(EntityReg.EXPLOSIVES_EXOTHERMIC,          EventBlastExothermic::new,         ItemReg.EXPLOSIVES_EXOTHERMIC));
    public static final RegistryObject<Block> EXPLOSIVES_ENDOTHERMIC        = BLOCKS.register("explosives_endothermic",         () -> new BlockExplosives(EntityReg.EXPLOSIVES_ENDOTHERMIC,         EventBlastEndothermic::new,        ItemReg.EXPLOSIVES_ENDOTHERMIC));
    public static final RegistryObject<Block> EXPLOSIVES_ANTIGRAVITATIONAL  = BLOCKS.register("explosives_antigravitational",   () -> new BlockExplosives(EntityReg.EXPLOSIVES_ANTIGRAVITATIONAL,   EventBlastAntigravitational::new,  ItemReg.EXPLOSIVES_ANTIGRAVITATIONAL));
    public static final RegistryObject<Block> EXPLOSIVES_ENDER              = BLOCKS.register("explosives_ender",               () -> new BlockExplosives(EntityReg.EXPLOSIVES_ENDER,               EventBlastEnder::new,              ItemReg.EXPLOSIVES_ENDER));
    public static final RegistryObject<Block> EXPLOSIVES_HYPERSONIC         = BLOCKS.register("explosives_hypersonic",          () -> new BlockExplosives(EntityReg.EXPLOSIVES_HYPERSONIC,          EventBlastHypersonic::new,         ItemReg.EXPLOSIVES_HYPERSONIC));
    public static final RegistryObject<Block> EXPLOSIVES_ANTIMATTER         = BLOCKS.register("explosives_antimatter",          () -> new BlockExplosives(EntityReg.EXPLOSIVES_ANTIMATTER,          EventBlastAntimatter::new,         ItemReg.EXPLOSIVES_ANTIMATTER));
    public static final RegistryObject<Block> EXPLOSIVES_REDMATTER          = BLOCKS.register("explosives_redmatter",           () -> new BlockExplosives(EntityReg.EXPLOSIVES_REDMATTER,           EventBlastRedmatter::new,          ItemReg.EXPLOSIVES_REDMATTER));

    // Unconventional Explosives
    public static final RegistryObject<Block> S_MINE                        = BLOCKS.register("s_mine",                         () -> new BlockSMine(EntityReg.S_MINE, EventBlastSMine::new, ItemReg.S_MINE));
